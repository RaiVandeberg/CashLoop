...
export function Input({legend, type= "text", ...rest}: Props) {
    return (
        <fieldset className="flex flex-1 max-h-20 text-gray-100 focus-within:text-gray-300" >
            ...
            <input type={type} className="w-full h-12 rounded-lg border-gray-200 px-4 text-sm text-gray-400 bg-amber-50 outline-none focus: border-3 focus:border-red-300 "{...rest} />
        </fieldset>
    )
}